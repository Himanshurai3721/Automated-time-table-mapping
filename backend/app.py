"""
app.py - Flask Backend for AI Timetable Generator
==================================================
  - Unified Authentication (Admin, Student, Faculty)
  - CRUD: Teachers, Subjects, Classrooms, TimeSlots, Programs
  - AI Schedule Generation (Genetic Algorithm)
...
from models import db, User, Student, Program, Teacher, Subject, Classroom, TimeSlot, TimetableEntry
from scheduler import GeneticAlgorithm, chromosome_to_schedule
